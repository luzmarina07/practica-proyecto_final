              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <?php $con =1;foreach($listado as $value) {?>
                     ...
                     <tr>
                        <td><?php echo $con++;?></td>
                        <td><img src ="/imagen_producto/<?php echo $value->pro_imagen; ?>" alt=""></td>
                        ...
                        <td><?php echo $value->cat_nombre?></td>
                         ...
                         <td></td>
                         <td>
                         <td><a href="/editarProducto/<?php echo $value->id ?>" class="btn btn-primary"> Editar</a></td>
                         <td><a href="#" onclick="eliminarProducto('<?php echo $value->id ?>')" class="btn btn-primary"> Eliminar</a></td>
                         </td>
                        </tr>
                     <?php }?>
                    </tbody>
